...
The `swagger-ui` view can be found [here](/api/vnfres/v1/swagger).
The `ReDoc` view can be found [here](/api/vnfres/v1/redoc).
The swagger YAML document can be found [here](/api/vnfres/v1/swagger.yaml).
The swagger JSON document can be found [here](/api/vnfres/v1/swagger.json)."""
)
